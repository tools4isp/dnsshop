<?php
	...
	if(get_value_get('page') != FALSE){
		if(get_value_get('page') != 'uitloggen'){ if(file_exists('functions/'.get_value_get('page').'.php')){ require_once('functions/'.get_value_get('page').'.php'); } require_once(fix_is_file('content/'.get_value_get('page').'.php','content/home.php')); }
